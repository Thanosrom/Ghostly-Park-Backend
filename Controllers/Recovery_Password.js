    ...
    async send_Digits_To_Recovery_Email (req, res) {
      ...
      async change_Password (req, res) {
        ...
        try{
          ...
          if (!errorsRepeatPassword.isEmpty()) {
            return res.sendStatus(400);
          }
            ...
            bcrypt.hash(repeatPassword, saltRounds, async (err, hashRepeat) => {
                ...
                const results = await Recovery_Model.change_Password(hash,hashRepeat,email);
                if (results) {
                  return res.sendStatus(200);
                }
                else{
