...
const Register_Controller = {
  ...
  async check_If_Email_Exist(req, res) {
    ...
    await utils_Controller.email_Validator(req, res, false);
    if (res.headersSent) return;
