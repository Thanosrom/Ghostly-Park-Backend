...
const { search_Location } = require('./Update_Coins_Gems_Controller');

//Server Status
const server_Status_Limiter = rateLimit({
    windowMs: 10 * 1000, 
    max: 10, 
    message: 'Too many login attempts from this IP, please try again after some minutes',
    headers: true, 
});
...
module.exports = {
    ...
    get_Subscription_Limiter,get_Coins_Limiter,get_Gems_Limiter,plus_Coins_Limiter,minus_Coins_Limiter,minus_5_Coins_Limiter,plus_Gems_Limiter,minus_Gems_Limiter,
};